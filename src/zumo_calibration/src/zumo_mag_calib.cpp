...
bool ZumoMagCalib::Init()
{
   ...
   p_ZumoSubscription = this->create_subscription<zumo_msgs::msg::ZumoSensors>("/zumo/zumo_sensors", 100, std::bind(&ZumoMagCalib::ZumoSensorCb, this, _1)); 
...
///*********************************************************************************
void ZumoMagCalib::ZumoSensorCb(const zumo_msgs::msg::ZumoSensors::ConstSharedPtr pMsg)
{
   ...
   char report[80];
   snprintf(report, sizeof(report), "min: {%+6ld, %+6ld, %+6ld}    max: {%+6ld, %+6ld, %+6ld}",
